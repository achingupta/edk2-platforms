...
#define EFI_ACPI_PCI_RC_ECAM_INIT(PciIndex)                                    \
  {                                                                            \
    ...
    SGI_PCI_BUS_START(PciIndex, FixedPcdGet32 (PcdPciBusCountPerRb)),  /* Start Bus Number */ \
    SGI_PCI_BUS_END(PciIndex, FixedPcdGet32 (PcdPciBusCountPerRb)),    /* End Bus Number */   \
