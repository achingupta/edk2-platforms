   ...
   /* _OSC: Operating System Capabilities */
    ...
    Device (CL04) {   // Cluster 4
      ...
      Device (CP04) { // Neoverse N2 core 4
        ...
        Name (_CPC, Package()
          CPPC_PACKAGE_INIT (0x040006000500, 0x040006000504, 20, 160, 160, 115, 115, 5)
        )
    ...
    Device (CL05) {   // Cluster 5
      ...
      Device (CP05) { // Neoverse N2 core 5
        ...
        Name (_CPC, Package()
          CPPC_PACKAGE_INIT (0x040006000518, 0x04000600051C, 20, 160, 160, 115, 115, 5)
        )
    ...
    Device (CL06) {   // Cluster 6
      ...
      Device (CP06) { // Neoverse N2 core 6
        ...
        Name (_CPC, Package()
          CPPC_PACKAGE_INIT (0x040006000530, 0x040006000534, 20, 160, 160, 115, 115, 5)
       )
    ...
    Device (CL07) {   // Cluster 7
      ...
      Device (CP07) { // Neoverse N2 core 7
        ...
        Name (_CPC, Package()
          CPPC_PACKAGE_INIT (0x040006000548, 0x04000600054C, 20, 160, 160, 115, 115, 5)
       )
    ...
    Device (CL08) {   // Cluster 8
      ...
      Device (CP08) { // Neoverse N2 core 8
        ...
        Name (_CPC, Package()
          CPPC_PACKAGE_INIT (0x080006000500, 0x080006000504, 20, 160, 160, 115, 115, 5)
        )
    ...
    Device (CL09) {   // Cluster 9
      ...
      Device (CP09) { // Neoverse N2 core 9
        ...
        Name (_CPC, Package()
          CPPC_PACKAGE_INIT (0x080006000518, 0x08000600051C, 20, 160, 160, 115, 115, 5)
        )
    ...
    Device (CL10) {   // Cluster 10
      ...
      Device (CP10) { // Neoverse N2 core 10
        ...
        Name (_CPC, Package()
          CPPC_PACKAGE_INIT (0x080006000530, 0x080006000534, 20, 160, 160, 115, 115, 5)
        )
    ...
    Device (CL11) {   // Cluster 11
      ...
      Device (CP11) { // Neoverse N2 core 11
        ...
        Name (_CPC, Package()
          CPPC_PACKAGE_INIT (0x080006000548, 0x08000600054C, 20, 160, 160, 115, 115, 5)
        )
    ...
    Device (CL12) {   // Cluster 12
      ...
      Device (CP12) { // Neoverse N2 core 12
        ...
        Name (_CPC, Package()
          CPPC_PACKAGE_INIT (0x0C0006000500, 0x0C0006000504, 20, 160, 160, 115, 115, 5)
        )
    ...
    Device (CL13) {   // Cluster 13
      ...
      Device (CP13) { // Neoverse N2 core 13
        ...
        Name (_CPC, Package()
          CPPC_PACKAGE_INIT (0x0C0006000518, 0x0C000600051C, 20, 160, 160, 115, 115, 5)
        )
    ...
    Device (CL14) {   // Cluster 14
      ...
      Device (CP14) { // Neoverse N2 core 14
        ...
        Name (_CPC, Package()
          CPPC_PACKAGE_INIT (0x0C0006000530, 0x0C0006000534, 20, 160, 160, 115, 115, 5)
        )
    ...
    Device (CL15) {   // Cluster 15
      ...
      Device (CP15) { // Neoverse N2 core 15
        ...
        Name (_CPC, Package()
          CPPC_PACKAGE_INIT (0x0C0006000548, 0x0C000600054C, 20, 160, 160, 115, 115, 5)
        )
